    ...
    <div class="row">
      <div class="col-lg-3 mb-3">
        ...
        <ul class="list-unstyled small text-muted">
          <li class="mb-2"> <a href="/docs/5.0/about/team/">Bootstrap 팀</a>이 <a href="https://github.com/twbs/bootstrap/graphs/contributors">기여자 분들</a>과 도움으로 세상의 모든 사랑을 받아 디자인되고 빌드되었습니다.</li>
      ...
      <div class="col-6 col-lg-2 offset-lg-1 mb-3">
        ...
        <ul class="list-unstyled">
          ...
          <li class="mb-2"><a href="/docs/5.0/">문서</a></li>
          <li class="mb-2"><a href="/docs/5.0/examples/">예제</a></li>
          <li class="mb-2"><a href="https://opencollective.com/bootstrap">테마</a></li>
      ...
      <div class="col-6 col-lg-2 mb-3">
        <h5>가이드</h5>
        <ul class="list-unstyled">
          <li class="mb-2"><a href="/docs/5.0/getting-started/">시작하기</a></li>
          <li class="mb-2"><a href="/docs/5.0/examples/starter-template/">스타터 템플릿</a></li>
